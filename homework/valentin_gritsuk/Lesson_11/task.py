...
math_book = SchoolTextbook(
    'Алгебра', 'Герасимов', '43', '13-4124-124',
    False, 'Математика', '10', True
)
english_book = SchoolTextbook(
    'Язык', 'Петичкин', '21', '123542-124',
    False, 'Русский', '5', True
)
russ_book = SchoolTextbook(
    'Язык', 'Калинин', '64', '53-41432-122',
